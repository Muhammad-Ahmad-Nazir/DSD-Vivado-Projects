...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task4/Lab8_Task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_in_Serial_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Parallel_in_Serial_out.tcl
