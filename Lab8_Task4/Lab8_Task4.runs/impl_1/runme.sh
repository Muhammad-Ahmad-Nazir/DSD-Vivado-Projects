...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task4/Lab8_Task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_in_Serial_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parallel_in_Serial_out.tcl -notrace
