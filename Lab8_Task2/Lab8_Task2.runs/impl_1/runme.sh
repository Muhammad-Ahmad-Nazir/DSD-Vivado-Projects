...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task2/Lab8_Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Serial_in_Parallel_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Serial_in_Parallel_out.tcl -notrace
