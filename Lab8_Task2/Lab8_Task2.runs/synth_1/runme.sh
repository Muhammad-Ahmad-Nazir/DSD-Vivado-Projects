...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task2/Lab8_Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Serial_in_Parallel_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Serial_in_Parallel_out.tcl
