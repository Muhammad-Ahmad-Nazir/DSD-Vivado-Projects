...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab0/Lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_4_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_4_bit.tcl
