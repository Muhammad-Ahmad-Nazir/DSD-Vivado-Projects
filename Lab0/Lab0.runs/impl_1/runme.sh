...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab0/Lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder_4_bit.tcl -notrace
