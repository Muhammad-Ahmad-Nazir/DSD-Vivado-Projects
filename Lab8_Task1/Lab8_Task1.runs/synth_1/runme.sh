...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task1/Lab8_Task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Serial_in_Serial_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Serial_in_Serial_out.tcl
