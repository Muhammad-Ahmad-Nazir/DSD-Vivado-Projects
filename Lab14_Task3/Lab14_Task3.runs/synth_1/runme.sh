...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task3/Lab14_Task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Moore_FSM_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Moore_FSM_ROM.tcl
