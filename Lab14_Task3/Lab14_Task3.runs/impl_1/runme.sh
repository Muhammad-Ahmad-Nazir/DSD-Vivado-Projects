...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task3/Lab14_Task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Moore_FSM_ROM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Moore_FSM_ROM.tcl -notrace
