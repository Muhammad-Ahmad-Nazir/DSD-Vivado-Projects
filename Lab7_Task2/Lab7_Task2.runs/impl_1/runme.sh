...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab7_Task2/Lab7_Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_slave_FF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Master_slave_FF.tcl -notrace
