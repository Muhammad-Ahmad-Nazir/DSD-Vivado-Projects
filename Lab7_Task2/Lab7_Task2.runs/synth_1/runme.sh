...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab7_Task2/Lab7_Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_slave_FF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_slave_FF.tcl
