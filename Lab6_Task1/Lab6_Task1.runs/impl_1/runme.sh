...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab6_Task1/Lab6_Task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder_2x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder_2x4.tcl -notrace
