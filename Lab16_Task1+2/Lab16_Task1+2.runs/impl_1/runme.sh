...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab16_Task1+2/Lab16_Task1+2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_multiplier_3x3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary_multiplier_3x3.tcl -notrace
