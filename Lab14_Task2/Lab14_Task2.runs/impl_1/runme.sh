...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task2/Lab14_Task2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Moore_sequence_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Moore_sequence_detector.tcl -notrace
