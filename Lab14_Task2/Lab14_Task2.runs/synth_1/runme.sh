...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task2/Lab14_Task2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Moore_sequence_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Moore_sequence_detector.tcl
