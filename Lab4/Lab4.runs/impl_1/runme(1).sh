...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_Decrementer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Segment_Decrementer.tcl -notrace
