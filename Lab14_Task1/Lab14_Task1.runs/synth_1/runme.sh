...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task1/Lab14_Task1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_sequence_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mealy_sequence_detector.tcl
