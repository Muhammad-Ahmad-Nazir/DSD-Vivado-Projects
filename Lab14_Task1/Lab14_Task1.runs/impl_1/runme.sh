...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab14_Task1/Lab14_Task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_sequence_detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mealy_sequence_detector.tcl -notrace
