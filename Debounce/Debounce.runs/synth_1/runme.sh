...
HD_PWD='C:/Users/Asif/VivadoProjects/Debounce/Debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debounce_better_version.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debounce_better_version.tcl
