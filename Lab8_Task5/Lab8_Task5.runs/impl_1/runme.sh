...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task5/Lab8_Task5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ring_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ring_counter.tcl -notrace
