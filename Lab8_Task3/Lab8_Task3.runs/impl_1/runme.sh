...
HD_PWD='C:/Users/Asif/VivadoProjects/Lab8_Task3/Lab8_Task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parallel_in_Parallel_out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parallel_in_Parallel_out.tcl -notrace
